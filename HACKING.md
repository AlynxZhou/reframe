...
**Do NOT submit AI/LLM generated code, unless you really understand what they are doing!** You are responsible to double check the generated code, not me! Isn't it silly that you pay for tokens to let AI/LLM generate code, and then ask me to review the code for free?

Basically AI/LLM should share the same rules and suggestions with human on submitting PR. There are some common mistakes that AI/LLM tends to do, and you at least should ensure you don't submit PRs with them: don't add unnecessary code or configurations, don't change the meaning of existing configurations, don't add non-existing test cases. In other words, if the quality of code generated by AI/LLM is the same as code written by human, there is no reason that I refuse them.

I'll only accept PRs from a responsible human, and refuse PRs if I seem to talk with an AI/LLM agent that acts like a human, as far as I can run an AI/LLM locally for myself, why I have to spend time talking with them on GitHub?

I'll keep a **hall of shame** of purely AI/LLM generated garbage that wasted my time here:

- <https://github.com/AlynxZhou/reframe/pull/31>: AI/LLM adds incomplete code to fix and test a non-existing bug. It seems I am not talking with a human.
- <https://github.com/AlynxZhou/reframe/pull/40>: AI/LLM adds a lot of unnecessary code, changes the meaning of existing configurations. The author cannot clearly explain what this PR is doing, and closed this PR without answering my question.
- <https://github.com/AlynxZhou/reframe/pull/41>: AI/LLM adds a lot of unnecessary code, makes this PR too complex and large to review.
